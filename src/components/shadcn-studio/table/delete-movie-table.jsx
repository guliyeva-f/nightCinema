                                ...
                                <TableRow key={movie.id}>
                                    ...
                                    <TableCell>
                                        <div className='h-20 flex justify-center'>
                                            <img className="h-full object-cover rounded"
                                                src={movie.coverPhotoUrl && movie.coverPhotoUrl.startsWith("http")
                                                    ? movie.coverPhotoUrl : "https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/No-Image-Placeholder.svg/330px-No-Image-Placeholder.svg.png"
                                                } onError={(e) => {
                                                    e.currentTarget.src =
                                    ...
                                    <TableCell>
                                        <div className="flex items-center justify-end gap-3">
                                            <Button variant='outline' size={0} className={'rounded-2xl'}
                                                onClick={() => {
