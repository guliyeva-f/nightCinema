              ...
              <TableRow key={user.id}>
                <TableCell>
                  <div className="flex items-center gap-3">
                    <Avatar>
                      <AvatarImage src={user.profilePhotoUrl || "https://cdn.shadcnstudio.com/ss-assets/avatar/avatar-1.png"} alt={user.username} />
                ...
                <TableCell className="flex justify-center">
                  <AlertDialog>
                    <AlertDialogTrigger asChild><button className="button" disabled={deletingId === user.id}> {deletingId === user.id ? (
                    ...
                    <AlertDialogContent>
                      ...
                      <AlertDialogFooter>
                        ...
                        <AlertDialogAction onClick={() => handleDelete(user.id)} className="bg-red-700 cursor-pointer text-white hover:bg-red-700/90">Delete User
                        </AlertDialogAction>
                      </AlertDialogFooter>
                    </AlertDialogContent>
                  </AlertDialog>
