...
function TagsInputList({
  ...
  return (
    <div
      ...
      className={cn(
        "flex min-h-12 p-1 w-full flex-wrap items-center gap-[2px_6px] rounded-md border border-input dark:bg-input/30 px-2 text-sm focus-within:ring-1 focus-within:ring-ring disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      {...props} />
  );
